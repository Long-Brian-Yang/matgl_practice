...
def main():
    ...
    # Load fine-tuned model directly from your saved model
    model_path = "/Users/brian/Documents/matgl_practice/m3gnet_potential/training_finetuning_m3gnet_potential/finetuned_model"
