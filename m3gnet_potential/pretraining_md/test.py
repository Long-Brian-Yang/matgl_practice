...
def parse_args():
    ...
    parser.add_argument('--model-path', type=str,
                      default="/Users/brian/Documents/matgl_practice/m3gnet_potential/json_training_finetuning_m3gnet_potential/finetuned_model",
...
def analyze_msd(trajectories: list, proton_index: int, temperatures: list, 
    ...
    plt.savefig(output_dir / 'msd_all_temperatures.png', dpi=300, bbox_inches='tight')
    plt.close()
